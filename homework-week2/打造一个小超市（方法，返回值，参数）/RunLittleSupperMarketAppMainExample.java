...
public class RunLittleSupperMarketAppMainExample {
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("今日超市大甩卖，所有商品第二件半价！选择要购买的商品索引：");
            ...
            int fullPriceCount = numToBuy / 2 + numToBuy % 2; //对数 , 余下的那个
            int halfPriceCount = numToBuy - fullPriceCount; //全价数量 - 半价数量
